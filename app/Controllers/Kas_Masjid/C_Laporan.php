...
class C_Laporan extends BaseController
{
    ...
    public function view()
    {
        ...
        return view('admin/kas_masjid/laporan/_laporan', $data);
    }
    public function cetak()
    {
        ...
        $data['rekap'] = $this->kasMasjid->sortir($tanggal_awal, $tanggal_akhir);

        $data['jumlahPemasukan'] = $this->kasMasjid->where('tanggal>=', $tanggal_awal)->where('tanggal<=', $tanggal_akhir)->selectSum('pemasukan')->first()->pemasukan;
        $data['jumlahPengeluaran'] = $this->kasMasjid->where('tanggal>=', $tanggal_awal)->where('tanggal<=', $tanggal_akhir)->selectSum('pengeluaran')->first()->pengeluaran;
        ...
        // load HTML content
        $dompdf->loadHtml(view('admin/kas_masjid/laporan/_cetak', $data));
