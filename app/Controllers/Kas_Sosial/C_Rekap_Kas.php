...
class C_Rekap_Kas extends BaseController
{
    public function __construct()
    {
        ...
        $this->pemasukan = $this->kasSosial->selectSum('pemasukan')->first()->pemasukan;
        $this->pengeluaran = $this->kasSosial->selectSum('pengeluaran')->first()->pengeluaran;
    ...
    public function index()
    {
        ...
        $data['rekap'] = $this->kasSosial->ambilData();
        ...
        return view('admin/kas_sosial/rekap/_rekapKas', $data);
    }
    public function sortirData()
    {
        ...
        $sortir = $this->kasSosial->sortir($tanggal_awal, $tanggal_akhir);
        $data['rekap'] = $sortir;
        // Hitung jumlah Pemasukan dan pengeluaran setelah disortir 
        $pemasukan = $this->kasSosial->selectSum('pemasukan')->where('tanggal >=', $tanggal_awal)
            ->where('tanggal <=', $tanggal_akhir)->first()->pemasukan;
        $pengeluaran = $this->kasSosial->selectSum('pengeluaran')->where('tanggal >=', $tanggal_awal)
