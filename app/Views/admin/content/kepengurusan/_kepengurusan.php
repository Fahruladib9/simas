    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?= base_url(); ?>admin/tambah-kepengurusan" method="post" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Kepengurusan</h5>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Kepengurusan</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    <?php foreach ($kepengurusan as $key => $value) : ?>
                                        <tr>
                                            ...
                                            <td><?= $value->jabatan; ?></td>
                                            <td><?= $value->pesan; ?></td>
                                            <td><img width="150px" class="img-thumbnail" src="<?= base_url() . "/assets/img/kepengurusan/" . $value->gambar; ?>"></td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= base_url() . "admin/edit-kepengurusan/" . $value->id_kepengurusan; ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                                <form action="<?= base_url() . "admin/delete-kepengurusan/" . $value->id_kepengurusan; ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin Mau Hapus Data')">
