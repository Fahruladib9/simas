...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Rekap-Kas-Sosial</li>
                    </ol>
                </div>
            </div>
            <div class="row">
            ...
            <form action="<?= base_url("admin/sortir-sosial"); ?>" method="POST">
                <div class="row">
                    <div class="col-sm-2">
                        <!-- text input -->
                    ...
                    <div class="row-sm-2 align-self-center mt-3">
                        ...
                        <a href="<?= base_url("admin/rekap-kas-sosial"); ?>" class="btn btn-primary ml-1">Lihat Semua Data</a>
                    </div>
                </div>
            </form>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Kas Sosial</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
