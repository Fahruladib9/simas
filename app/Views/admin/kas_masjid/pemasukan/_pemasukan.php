...
<?= $this->section('title'); ?>
<title>Pemasukan Kas Masjid</title>
<?= $this->endSection(); ?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Pemasukan Kas Masjid</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Pemasukan-Masjid</li>
                    </ol>
                </div>
            </div>
    ...
    <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?= base_url("admin/tambah-pemasukan-masjid"); ?>" method="post">
                                        ...
                                        <?php if ($value->pemasukan != "0") : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="<?= base_url("admin/edit-pemasukan-masjid/") . $value->id_kasMasjid; ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                                                    <form action="<?= base_url("admin/delete-pemasukan-masjid/") . $value->id_kasMasjid; ?>" method="post" class="d-inline" onsubmit="return confirm('Yakin Mau Hapus Data')">
